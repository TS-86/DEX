...
export const Swap4: React.FC<Props> = ({tokenA, tokenB}) => {
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="flex justify-center">
            ...
            <input
              ...
              name="Amount"
              id="amount"
              className="mx-2 flex-item shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block 
               border-gray-300 rounded-md text-gray-800 text-2xl w-1/6 text-center"
              placeholder="20"
          ...
          <button
            type="submit"
            className="mt-3 inline-flex items-center justify-center px-4 py-2 border border-transparent 
            shadow-sm font-medium rounded-md text-white bg-gray-800 hover:bg-indigo-700 
