...
import { MyToken3 } from "./typechain/MyToken3";
import { MyToken3__factory } from "./typechain/factories/MyToken3__factory";
...
export const MyToken3Context = React.createContext<SymfoniMyToken3>(emptyContract);
...
export interface SymfoniMyToken3 {
    instance?: MyToken3;
    factory?: MyToken3__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [MyToken3, setMyToken3] = useState<SymfoniMyToken3>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                ...
                setMyToken3(getMyToken3(_provider, _signer))
                finish(text)
            }
    ...
    const getUniswapV2Factory = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contractAddress = "0x01D6632259F1d4Ad7C8a93036413963457396aCB"
    ...
    const getUniswapV2Router02 = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contractAddress = "0x841eCE8d351361aC775299ebfCb207e966387F04"
    ...
    const getMyToken1 = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contractAddress = "0x6215682EadF1971D66695b7211a1Ef6Bffd62560"
    ...
    const getMyToken2 = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contractAddress = "0xe40811C538a5e5FF60e614Ce903Fe86869Eb306a"
        ...
        ;
    const getMyToken3 = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = "0x7bBEE99cFd797791CFF5eDCC0f23CA58D107AA24"
        const instance = _signer ? MyToken3__factory.connect(contractAddress, _signer) : MyToken3__factory.connect(contractAddress, _provider)
        const contract: SymfoniMyToken3 = {
            instance: instance,
            factory: _signer ? new MyToken3__factory(_signer) : undefined,
        }
        return contract
    }
        ;
                                            ...
                                            <MyToken1Context.Provider value={MyToken1}>
                                                <ERC20Context.Provider value={ERC20}>
                                                    <MyToken2Context.Provider value={MyToken2}>
                                                        <MyToken3Context.Provider value={MyToken3}>
                                                            {showLoading && loading ?
